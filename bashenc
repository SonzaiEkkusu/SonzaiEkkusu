...
def sprint(sentence, second=0.001):
...
def about():
    os.system("clear")
    print(f"{cyan}[ToolName]  {purple} :[Shell Fucker]")
    print(f"{cyan}[Version]   {purple} :[X]")
...
def encryptsh():
    ...
    with open(".temp",'r') as temp_f, open(out_file,'w') as out_f:
        ...
        out_f.write("# Encrypted by Sonzai-X\n\n"+filedata)
    os.remove(".temp")
...
def decryptsh():
    ...
    with open(".temp2",'r') as temp_f2, open(out_file,'w') as out_f:
        ...
        out_f.write("# Decrypted by Sonzai-X\n\n"+filedata)
    os.remove(".temp2")
    sprint(f"{success}{out_file} saved in {pwd}")
    mover(out_file)
...
def main():
    ...
    print(f"{green}[5]{yellow} PM Owner")
    ...
    while True:
        if choose == "1" or choose=="01":
            ...
            if os.path.exists("/data/data/com.termux/files/home"):
                os.system("xdg-open --view 'https://t.me/November2k'")
            else:
                os.system("xdg-open 'https://t.me/November2k'")
            main()
